...
CPATHS=/Users/afarber/src/jetty-newbie/WebsocketHandler/target/classes 
...
CPATHS=$CPATHS:$REPO/org/postgresql/postgresql/9.4.1208.jre7/postgresql-9.4.1208.jre7.jar

/Library/Java/JavaVirtualMachines/jdk1.8.0_45.jdk/Contents/Home/bin/java \
        -classpath $CPATHS de.afarber.MyHandler
